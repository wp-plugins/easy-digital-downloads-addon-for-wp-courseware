...
The Easy Digital Downloads Addon for WP Courseware will add full integration with WP Courseware. It will allow you to assign WP Courseware course(s) to a product. Once the course(s) are assigned to a product, upon purchase of a product and registration, a student will automatically be enrolled into the associated course(s).

With this addon, you will be able to create a fully automated LMS system in which you can sell courses online.

= Easy Digital Downloads Plugin Integration with WP Courseware Plugin =
[youtube https://www.youtube.com/watch?v=B72kzjPdl7s]
...
1. Upload the `Easy Digital Downloads for WP Courseware addon` folder into the `/wp-content/plugins/` directory
...
= Does this plugin require Easy Digital Downloads to already be installed =
